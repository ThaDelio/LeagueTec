...
namespace Talon by ThaDelio
{
    ...
    {
        public static Menu Menu = new Menu("Talon by ThaDelio", "Talon by ThaDelio", true);
        ...
        public Talon()
        {
            ...
            var BurstMenu = new Menu("burst", "Burst");
            {
                ...
                BurstMenu.Add(new MenuBool("waitW", "Wait for W"));
            }
            Menu.Add(BurstMenu);
            Menu.Attach();
            ...
            LoadSpells();
            Console.WriteLine("Talon by ThaDelio - Loaded");
        }
